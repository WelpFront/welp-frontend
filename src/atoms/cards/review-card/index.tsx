...
const ReviewCard = ({ item }: { item: ReviewType }) => {
	...
	return (
		<div className="flex flex-col  gap-3" dir="ltr">
			<div className="flex items-start gap-3 md:gap-5 text-gray-400">
				...
				<div className="flex flex-col gap-5 items-start justify-center flex-1">
					<div className="flex flex-col gap-2">
						...
						<div className="hidden md:flex w-full md:text-justify ">
							{item.caption}
						</div>
					</div>
				</div>

				<div className="flex items-center flex-nowrap gap-1 md:gap-2 px-3 py-1 select-none">
			...
			<div className="md:hidden flex w-full md:text-justify ">
				{item.caption}
			</div>
		</div>
	);
